...
<header class="top-header">
	<nav class="navbar navbar-expand-lg navbar-light bg-white shadow py-3">
		<div class="container">
			<a class="navbar-brand" href="{{ route('home') }}">Career Hub</a>
...
<div class="container">
    <p class="text-center text-white pt-3 fw-bold fs-6"><i class="fa fa-code" aria-hidden="true"></i> Developers : Shubham, Akash, Khushal
 </p>
</div>
</footer> 
